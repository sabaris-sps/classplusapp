...
const dataList = ['fulltest_1.json', 'module_3.json', 'module_2.json', 'module_1.json']

export const TESTS: TestMetadata[] = [
  { id: '1', name: 'Full test 1', fileName: 'fulltest_1.json' },
  { id: '2', name: 'Module 3', fileName: 'module_3.json' },
  { id: '3', name: 'Module 2', fileName: 'module_2.json' },
  { id: '4', name: 'Module 1', fileName: 'module_1.json' },
];
